...
function transformBody(insomniaBody) {
    ...
    switch (insomniaBody.mimeType) {
        ...
        case "application/octet-stream":
            ...
            break;
        default:
            console.warn("Warning: Body type unsupported; skipped!!! ... " +
...
function getCollectionName(insomniaParentChildList) {
...
function parseInsomniaCollection(inputDataString) {
    const inputData = JSON.parse(inputDataString);
    console.log("Parsing Insomnia collection...");
    if (inputData.__export_format !== 4) {
        console.error("Error: Version (__export_format " +
...
module.exports = { parseInsomniaCollection };